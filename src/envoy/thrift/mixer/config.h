...
// Config for thrift filter.
class Config {
 public:
  Config(const ::istio::mixer::v1::config::client::ThriftClientConfig& config_pb)
  ...
  const ::istio::mixer::v1::config::client::ThriftClientConfig& config_pb() const {
    return config_pb_;
  }
 ...
 private:
  // The Thrift client config.
  ::istio::mixer::v1::config::client::ThriftClientConfig config_pb_;
