...
#include "src/envoy/thrift/mixer/control.h"
...
class Filter : public Network::Filter,
               ...
               public ::istio::control::thrift::CheckData,
               public ::istio::control::thrift::ReportData,
 ...
 public:
  ...
  void GetReportInfo(
      ::istio::control::thrift::ReportData::ReportInfo *data) const override;
 ...
 private:
  ...
  Control &control_;
  // pre-request handler
  std::unique_ptr<::istio::control::thrift::RequestHandler> handler_;
  // filter callback
