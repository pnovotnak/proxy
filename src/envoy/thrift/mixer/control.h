...
#include "src/envoy/thrift/mixer/config.h"
...
class ControlData {
 ...
 private:
  ...
  // UUID of the Envoy Thrift mixer filter.
...
class Control final : public ThreadLocal::ThreadLocalObject {
 public:
  ...
  ::istio::control::thrift::Controller* controller() { return controller_.get(); }
 ...
 private:
  ...
  // The mixer control
  std::unique_ptr<::istio::control::thrift::Controller> controller_;
};
