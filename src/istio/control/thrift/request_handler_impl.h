...
#ifndef ISTIO_CONTROL_THRIFT_REQUEST_HANDLER_IMPL_H
#define ISTIO_CONTROL_THRIFT_REQUEST_HANDLER_IMPL_H

#include "include/istio/control/thrift/request_handler.h"
#include "src/istio/control/thrift/client_context.h"
#include "src/istio/control/thrift/service_context.h"
...
// The class to implement THRIFTRequestHandler interface.
...
#endif  // ISTIO_CONTROL_THRIFT_REQUEST_HANDLER_IMPL_H
