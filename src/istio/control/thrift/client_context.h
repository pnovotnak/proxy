...
#ifndef ISTIO_CONTROL_THRIFT_CLIENT_CONTEXT_H
#define ISTIO_CONTROL_THRIFT_CLIENT_CONTEXT_H

#include "include/istio/control/thrift/controller.h"
...
public:
    ...
    const ::istio::mixer::v1::config::client::ThriftClientConfig& config() const {
        return config_;
    }
...
private:
    // The thrift client config.
    const ::istio::mixer::v1::config::client::ThriftClientConfig& config_;
...
#endif  // ISTIO_CONTROL_THRIFT_CLIENT_CONTEXT_H
