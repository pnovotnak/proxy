...
// TODO (peter.novotnak@reddit.com) these tests are most certainly busted.

#include "google/protobuf/text_format.h"
#include "gtest/gtest.h"
#include "include/istio/utils/attribute_names.h"
#include "src/istio/control/thrift/client_context.h"
#include "src/istio/control/thrift/controller_impl.h"
#include "src/istio/control/thrift/mock_check_data.h"
#include "src/istio/control/thrift/mock_report_data.h"
...
class RequestHandlerImplTest : public ::testing::Test {
 public:
  ...
  ThriftClientConfig client_config_;
...
TEST_F(RequestHandlerImplTest, TestPerRouteApiSpec) {
  ...
  ServiceConfig config;
  auto api_spec = config.add_thrift_api_spec();
