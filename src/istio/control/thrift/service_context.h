...
#ifndef ISTIO_CONTROL_THRIFT_SERVICE_CONTEXT_H
#define ISTIO_CONTROL_THRIFT_SERVICE_CONTEXT_H

#include "google/protobuf/stubs/status.h"
#include "include/istio/api_spec/thrift_api_spec_parser.h"
...
// The context to hold service config for both THRIFT and TCP.
class ServiceContext {
 ...
 private:
  ...
  ::istio::mixer::v1::config::client::THRIFTAPISpec api_spec_;
  // Api spec parser to generate api attributes and api_key
  std::unique_ptr<::istio::api_spec::ThriftApiSpecParser> api_spec_parser_;
...
#endif  // ISTIO_CONTROL_THRIFT_SERVICE_CONTEXT_H
