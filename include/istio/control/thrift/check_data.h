...
#ifndef ISTIO_CONTROL_THRIFT_CHECK_DATA_H
#define ISTIO_CONTROL_THRIFT_CHECK_DATA_H
...
// The interface to extract THRIFT data for Mixer check call.
// Implemented by the environment (Envoy) and used by the library.
class CheckData {
 public:
  virtual ~CheckData() {}

  // TODO(peter.novotnak@reddit.com): figure out what fields go here

  // Get downstream thrift connection ip and port.
  ...
  // Get downstream thrift connection id.
...
#endif  // ISTIO_CONTROL_THRIFT_CHECK_DATA_H
