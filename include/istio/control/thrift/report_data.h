...
#ifndef ISTIO_CONTROL_THRIFT_REPORT_DATA_H
#define ISTIO_CONTROL_THRIFT_REPORT_DATA_H
...
// The interface to extract THRIFT data for Mixer report call.
// Implemented by the environment (Envoy) and used by the library.
class ReportData {
 public:
  virtual ~ReportData() {}

  // Get upstream thrift connection IP and port. IP is returned in format of bytes.
  ...
  // ConnectionEvent is used to indicates the thrift connection event in Report
  // call.
...
#endif  // ISTIO_CONTROL_THRIFT_REPORT_DATA_H
